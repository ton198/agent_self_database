...
3. Copy `.env.example` to `.env` and set `ANTHROPIC_API_KEY`. Gating defaults to `CLAUDE_GATE_MODEL=claude-haiku-4-5`.
...
- My test: Capturing the foreground window works the best. Full screen would easily lose focus.